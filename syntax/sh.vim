...
"
" For my changes (Nicolas Pouillard), see "NP:" parts.
...
if exists("b:is_kornshell") || exists("b:is_bash")
 ...
 syn region shCaseEsac matchgroup=shConditional start="\_sselect\s" matchgroup=shConditional end="\<in\>" end="\<do\>" contains=@shLoopList
else
...
" NP: Let's target POSIX, hence the if 1
if 1
 " exists("b:is_kornshell") || exists("b:is_bash")
